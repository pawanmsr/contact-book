        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{action('AdminController@updatecontact', $id)}}" method="POST">
                        {{ csrf_field() }}
                        <div class="form-group">
                            <input type="text" name="user" class="form-control" value="{{$contact->user}}" placeholder="Enter email id of user" />
                        </div>
                        <div class="form-group">
